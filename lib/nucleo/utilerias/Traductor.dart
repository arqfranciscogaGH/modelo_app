...
class Traductor {
  ...
  static dynamic obtenerEtiquetaAtributo(
      String seccion, String elemento, String atributo) {
    dynamic valorElemento;
  ...
  static dynamic obtenerAtrbuto(
      String seccion, String elemento, String atributo) {
    dynamic valorElemento;
    dynamic valorAtributo;
    try {
      valorElemento = obtenerElemento(seccion, elemento);
      if (valorElemento != null) valorAtributo = valorElemento[atributo];
      return valorAtributo;
    } catch (error) {
      return valorAtributo;
    }
