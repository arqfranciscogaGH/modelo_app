...
class Menulateral {
  static Widget crearMenu(
    ...
    return Drawer(
      ...
      child: ListView(
          ...
          children: Menulateral.crearElementosListaMenuLateral(
              context, elementos, encabezado)),
    );
  }

  static Widget crearEncabezadoMenu(BuildContext context,
      List<dynamic> elementos, String titulo, String pagina) {
  ...
  static Widget crearSeccionAcceso(
      BuildContext context, String titulo, String pagina) {
    return Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: crearItemsSeccionAcceso(context, titulo, pagina));
  }

  static List<Widget> crearItemsSeccionAcceso(
      BuildContext context, String titulo, String pagina) {
    ...
    controles
        .add(Text(" v : " + Sesion.version + " ", textAlign: TextAlign.left));
    controles.add(boton);
  ...
  static Widget crearSeccionSesion() {
    return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: crearItemsSeccionSesion());
  }

  static List<Widget> crearItemsSeccionSesion() {
    final List<Widget> controles = [];
    // controles.add(Text(" " ));
    String titulo = Traductor.obtenerEtiquetaAtributo(
        'comun_pagina', 'suscripcion', 'titulo');

    controles.add(Text(
        " Id:" +
            Sesion.idSuscriptor.toString() +
            " " +
            titulo +
            ":" +
            Sesion.suscriptor,
    ...
    titulo =
        Traductor.obtenerEtiquetaAtributo('comun_pagina', 'cuenta', 'titulo');
    controles
        .add(Text(titulo + ":" + Sesion.cuenta, textAlign: TextAlign.left));
    titulo =
        Traductor.obtenerEtiquetaAtributo('comun_pagina', 'nombre', 'titulo');
    controles
        .add(Text(titulo + ":" + Sesion.nombre, textAlign: TextAlign.left));
    titulo =
        Traductor.obtenerEtiquetaAtributo('comun_pagina', 'perfil', 'titulo') +
            ":" +
            Sesion.perfiles +
            " ";
    titulo +=
        Traductor.obtenerEtiquetaAtributo('comun_pagina', 'grupo', 'titulo') +
            ":" +
            Sesion.grupos;
  ...
  static List<Widget> crearElementosListaMenuLateral(
      BuildContext context, List<dynamic> elementos, Widget encabezado) {
  ...
  static Widget crearOpcionMenuLateral(
    ...
    return ListTile(
      ...
      trailing: elemento.iconoLateral != null
          ? Icono.crear(elemento.iconoLateral!, elemento.colorIcono,
              elemento.tamanoIcono!)
          : null,
      onTap: () {
