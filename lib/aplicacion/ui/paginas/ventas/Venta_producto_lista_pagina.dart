...
class Venta_producto_lista_pagina extends StatefulWidget {
  ...
  @override
  _Venta_producto_lista_pagina_state createState() =>
      _Venta_producto_lista_pagina_state();
}

class _Venta_producto_lista_pagina_state
    extends State<Venta_producto_lista_pagina> {
  //  propiedades  widget
  ...
  void initState() {
    ...
    entidadCaptura = ui.asignarIdEntidadPadre(entidadCaptura);
    ...
    //
    //  filtrar tabla
    ui.tabla!.filtrarTabla(entidadCaptura, 'idVenta', entidadCaptura.idVenta);
    //
    //  filtrar lista
    ...
    accionConsultar = ElementoLista(
      ...
      accion3: ui.seleccionarElemento2,
      callBackAccion3: ui.respuestaSeleccionar2,
    );
        ...
        appBar: NewGradientAppBar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () {
                Accion.hacer(
                    context, OpcionesMenus.obtener("Venta_captura_pagina"));
              },
            ),
          ],
        ),
