...
class _Modelo_pagina_captura_state extends State<Modelo_pagina_captura> {
  ...
  Widget build(BuildContext context) {
    ...
    prov = Provider.of<ControlEstadoUI>(context, listen: false);
  ...
  List<Widget> definicionControles(
    ...
    lisVariables = lisVariables.asignar(
        '', widget.pagina!, "si", 1, cambiarValor, validar);
    ...
    Control txtHoraCU = Control().crear('', widget.pagina!, "txtHoraCU",
        entidadCaptura.clave, 1, cambiarValor, validar);
    ...
    Control txtfechaCU = Control().crear('', widget.pagina!, "txtfechaCU",
        entidadCaptura.llave, 1, cambiarValor, validar);
    ...
    Control txtfechaCalendario = Control().crear('', widget.pagina!,
        "txtfechaCalendario", entidadCaptura.llave, 1, cambiarValor, validar);
    ...
    Control txtfechaSelector = Control().crear('', widget.pagina!,
        "txtfechaSelector", entidadCaptura.llave, 1, cambiarValor, validar);
    ...
    controles.add(Control().crear('', widget.pagina!, "txtimporte",
        entidadCaptura.id, 1, cambiarValor, validar));
    ...
    controles.add(Control().crear('', widget.pagina!, "txtruta",
        entidadCaptura.descripcion, 1, cambiarValor, validar));

    return cargarControlesCaptura(
        context, controles, '', widget.pagina!, cambiarValor, validar, []);
  }
